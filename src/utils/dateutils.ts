export function getDatesInWeek() {
    ...
    let datesInWeek: string[] = []; // empty array to be populated with dates in week to display (ex): ["9/22/2024", "9/23/2024", "9/24/2024", "9/25/2024", "9/26/2024", "9/27/2024", "9/28/2024"]
